...
//  Test1
//
//  Created by Masoud Heydari on 11/5/18.
...
public enum ToastPosition {
    ...
    fileprivate func centerPoint(forToast toast: UIView, inSuperview superview: UIView) -> CGPoint {
        let topPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview.csSafeAreaInsets.top + ToastManager.shared.style.topMargin
        let bottomPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview.csSafeAreaInsets.bottom + ToastManager.shared.style.bottomMargin
        ...
        case .bottom:
            print("is: \(ToastManager.shared.style.bottomMargin)")
